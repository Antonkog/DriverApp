package com.abona_erp.driver.timeline_view;
...
public class TimelineView extends View {
  ...
  private void init(AttributeSet attrs) {
    ...
    mMarker = ta.getDrawable(R.styleable.TimelineView_marker);
    mMarkerSize = ta.getDimensionPixelSize(R.styleable.TimelineView_markerSize, Utils.dpToPx(20, getContext()));
    mMarkerPaddingLeft = ta.getDimensionPixelSize(R.styleable.TimelineView_markerPaddingLeft, 0);
    mMarkerPaddingTop = ta.getDimensionPixelSize(R.styleable.TimelineView_markerPaddingTop, 0);
    mMarkerPaddingRight = ta.getDimensionPixelSize(R.styleable.TimelineView_markerPaddingRight, 0);
    mMarkerPaddingBottom = ta.getDimensionPixelSize(R.styleable.TimelineView_markerPaddingBottom, 0);
    mMarkerInCenter = ta.getBoolean(R.styleable.TimelineView_markerInCenter, true);
    mStartLineColor = ta.getColor(R.styleable.TimelineView_startLineColor, getResources().getColor(android.R.color.darker_gray));
    mEndLineColor = ta.getColor(R.styleable.TimelineView_endLineColor, getResources().getColor(android.R.color.darker_gray));
    mLineWidth = ta.getDimensionPixelSize(R.styleable.TimelineView_lineWidth, Utils.dpToPx(2, getContext()));
    mLineOrientation = ta.getInt(R.styleable.TimelineView_lineOrientation, LineOrientation.VERTICAL);
    mLinePadding = ta.getDimensionPixelSize(R.styleable.TimelineView_linePadding, 0);
    mLineStyle = ta.getInt(R.styleable.TimelineView_lineStyle, LineStyle.NORMAL);
    mLineStyleDashLength = ta.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashLength, Utils.dpToPx(8f, getContext()));
    mLineStyleDashGap = ta.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashGap, Utils.dpToPx(4f, getContext()));
    ta.recycle();
