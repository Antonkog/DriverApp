...
public class CustomNotesDialog extends Dialog implements View.OnClickListener {
  
  public CustomNotesDialog(Context context, int themeResId) {
    super(context, themeResId);
  }
  
  public CustomNotesDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
  ...
  public CustomNotesDialog(Activity a, RecyclerView.Adapter adapter, String orderNo, int actionTypeColor) {
    super(a);
    this.activity = a;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.custom_notes_layout);
