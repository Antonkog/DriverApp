...
public class CustomDangerousGoodsDialog extends Dialog implements View.OnClickListener {
  
  public CustomDangerousGoodsDialog(Context context, int themeResId) {
    super(context, themeResId);
  }
  
  public CustomDangerousGoodsDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
  ...
  public CustomDangerousGoodsDialog(Activity a, RecyclerView.Adapter adapter, String orderNo, int actionTypeColor) {
    super(a);
    this.activity = a;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.custom_dangerous_goods_layout);
