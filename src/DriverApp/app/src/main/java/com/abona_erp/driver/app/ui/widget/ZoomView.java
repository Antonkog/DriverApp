...
public class ZoomView extends AppCompatImageView implements OnScaleGestureListener {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.ZoomView);
  
    zoomable = values.getBoolean(R.styleable.ZoomView_zoomable, true);
    translatable = values.getBoolean(R.styleable.ZoomView_translatable, true);
    animateOnReset = values.getBoolean(R.styleable.ZoomView_animateOnReset, true);
    autoCenter = values.getBoolean(R.styleable.ZoomView_autoCenter, true);
    restrictBounds = values.getBoolean(R.styleable.ZoomView_restrictBounds, false);
    doubleTapToZoom = values.getBoolean(R.styleable.ZoomView_doubleTapToZoom, true);
    minScale = values.getFloat(R.styleable.ZoomView_minScale, MIN_SCALE);
    maxScale = values.getFloat(R.styleable.ZoomView_maxScale, MAX_SCALE);
    doubleTapToZoomScaleFactor = values.getFloat(R.styleable.ZoomView_doubleTapToZoomScaleFactor, 3);
    autoResetMode = AutoResetMode.Parser.fromInt(values.getInt(R.styleable.ZoomView_autoResetMode, AutoResetMode.UNDER));
