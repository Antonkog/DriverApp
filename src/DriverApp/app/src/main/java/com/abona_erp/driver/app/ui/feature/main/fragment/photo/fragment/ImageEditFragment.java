...
import com.abona_erp.driver.app.ui.feature.PhotoEditor.views.imagezoom.ImageViewTouch;
...
public class ImageEditFragment extends Fragment {
  ...
  private ImageViewTouch mPhotoEditorView;
  ...
  public void setBitmap(Bitmap bitmap, File file) {
    try {
      if (getContext() != null && bitmap == null) {
        mPhotoEditorView.setImageBitmap(drawableToBitmap(getContext().getResources().getDrawable(R.drawable.no_image_rect)));
      } else {
  ...
  private void initComponents(@NonNull View root) {
    mPhotoEditorView = (ImageViewTouch)root.findViewById(R.id.photo_editor_view);
  }
