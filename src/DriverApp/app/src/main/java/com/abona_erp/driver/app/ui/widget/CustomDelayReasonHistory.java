...
public class CustomDelayReasonHistory extends Dialog implements View.OnClickListener {
  
  public CustomDelayReasonHistory(Context context, int themeResId) {
    super(context, themeResId);
  }
  
  public CustomDelayReasonHistory(Context context, boolean cancelable, OnCancelListener cancelListener) {
  ...
  public CustomDelayReasonHistory(Activity a, RecyclerView.Adapter adapter, String orderNo, int actionType) {
    super(a);
    this.activity = a;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.custom_delay_reason_history);
