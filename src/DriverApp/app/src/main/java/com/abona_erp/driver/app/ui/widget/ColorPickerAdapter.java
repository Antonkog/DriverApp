...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
  ...
  public static List<Integer> getDefaultColors(Context context) {
    ...
    colorPickerColors.add(ContextCompat.getColor(context, R.color.purple_color_picker));
    ...
    colorPickerColors.add(ContextCompat.getColor(context, R.color.light_blue_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.cyan_color_picker));
    ...
    colorPickerColors.add(ContextCompat.getColor(context, R.color.lime_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.yellow_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.amber_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.orange_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.deep_orange_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.brown_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.grey_color_picker));
    colorPickerColors.add(ContextCompat.getColor(context, R.color.blue_grey_color_picker));
