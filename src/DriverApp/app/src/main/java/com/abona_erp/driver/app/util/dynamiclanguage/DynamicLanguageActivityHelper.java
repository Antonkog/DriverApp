package com.abona_erp.driver.app.util.dynamiclanguage;
...
public final class DynamicLanguageActivityHelper {
  ...
  public static void recreateIfNotInCorrectLanguage(Activity activity, String language) {
    ...
    if (!reentryKey.equals(reentryProtection)) {
      ...
      Log.d(TAG, String.format("Skipping recreate as looks like looping, Activity Locale %s, Selected locale %s",
        currentActivityLocale, selectedLocale));
    }
  }
}
