...
import com.abona_erp.driverapp.ui.fdocuments.task.BitmapCropTask
import com.abona_erp.driverapp.ui.fdocuments.util.CubicEasing.easeInOut
import com.abona_erp.driverapp.ui.fdocuments.util.CubicEasing.easeOut
import com.abona_erp.driverapp.ui.fdocuments.util.RectUtils.getCornersFromRect
import com.abona_erp.driverapp.ui.fdocuments.util.RectUtils.getRectSidesFromCorners
import com.abona_erp.driverapp.ui.fdocuments.util.RectUtils.trapToRect
...
open class CropImageView @JvmOverloads constructor(
    ...
    protected fun zoomImageToPosition(
        ...
        val deltaScale = currentScale - oldScale
    ...
    private class ZoomImageToPosition(
        ...
        private val mCropImageView: WeakReference<CropImageView> = WeakReference(cropImageView)
        private val mDurationMs = durationMs
        private val mStartTime: Long = System.currentTimeMillis()
        private val mOldScale: Float = oldScale
        private val mDeltaScale: Float = deltaScale
