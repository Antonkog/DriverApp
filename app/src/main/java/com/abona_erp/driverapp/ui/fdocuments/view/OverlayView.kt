...
open class OverlayView @JvmOverloads constructor(
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        var changeBottom = bottom
        super.onLayout(changed, changeLeft, changeTop, changeRight, changeBottom)
        if (changed) {
            changeLeft = paddingLeft
            changeTop = paddingTop
            changeRight = width - paddingRight
            changeBottom = height - paddingBottom
            mThisWidth = changeRight - changeLeft
            mThisHeight = changeBottom - changeTop
