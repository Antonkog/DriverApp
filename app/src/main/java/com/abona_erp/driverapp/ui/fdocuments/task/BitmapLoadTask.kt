...
import com.abona_erp.driverapp.ui.fdocuments.task.BitmapLoadTask.BitmapWorkerResult
...
class BitmapLoadTask(
    ...
    override fun doInBackground(vararg p0: Void?): BitmapWorkerResult {
        ...
        while (!decodeAttemptSuccess) {
            try {
                val stream =
                    mContext.contentResolver.openInputStream(mInputUri!!)
                try {
                ...
                Log.e(
                    TAG,
                    "doInBackground: ImageDecoder.createSource: ",
                    e
                )
