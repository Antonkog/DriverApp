...
import com.abona_erp.driverapp.ui.fdocuments.util.BitmapLoadUtils.calculateMaxBitmapSize
import com.abona_erp.driverapp.ui.fdocuments.util.BitmapLoadUtils.decodeBitmapInBackground
import com.abona_erp.driverapp.ui.fdocuments.util.FastBitmapDrawable
import com.abona_erp.driverapp.ui.fdocuments.util.RectUtils.getCenterFromRect
import com.abona_erp.driverapp.ui.fdocuments.util.RectUtils.getCornersFromRect
...
open class TransformImageView @JvmOverloads constructor(
    ...
    lateinit var imageInputPath: String
    lateinit var imageOutputPath: String
    lateinit var exifInfo: ExifInfo
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        super.onLayout(changed, leftPosition, topPosition, rightPosition, bottomPosition)
        if (changed || mBitmapDecoded && !mBitmapLaidOut) {
            leftPosition = paddingLeft
            topPosition = paddingTop
            rightPosition = width - paddingRight
            bottomPosition = height - paddingBottom
            mThisWidth = rightPosition - leftPosition
            mThisHeight = bottomPosition - topPosition
            onImageLaidOut()
        }
    }
