...
import com.abona_erp.driver.app.data.local.dao.DocumentsDao
import com.abona_erp.driver.app.data.local.dao.DriverActDao
import com.abona_erp.driver.app.data.local.dao.DriverTaskDao

@Database(entities = [ActivityEntity::class, TaskEntity::class, DocumentEntity::class], version = 1, exportSchema = false)
